 ...
 * @Author: Tao
 * @Date: 2022-02-04 20:20:26
 * @LastEditors: Tao
 * @LastEditTime: 2022-03-07 21:59:26
 -->
<template>
  <div id="details">
    <!-- 头部 -->
    ...
    <div class="main">
      ...
      <div class="content">
        ...
        <div class="pro-policy">
          <ul>
            <li>
              <i class="el-icon-circle-check"></i> Tao sell自营
            </li>
            <li>
              <i class="el-icon-circle-check"></i> Tao sell发货
            </li>
            <li>
