 ...
 * @LastEditors: Tao
 * @LastEditTime: 2022-02-17 13:36:12
 -->
<template>
        ...
        <div class="phone">
          ...
          <div class="box-bd">
            <div class="promo-list">
              <router-link to>
                <img :src="$target +'public/imgs/goods/phone.png'" />
              </router-link>
            </div>
            <div class="list">
...
export default {
  ...
  created() {
    ...
    // 获取各类商品数据
    this.getPromo("热卖女装", "phoneList");
    this.getPromo("口红", "miTvList");
    this.getPromo("戒指", "protectingShellList");
    this.getPromo("玉饰", "chargerList");
    this.getPromo(
      ["口红", "面膜", "水乳"],             //电视机在applianceList列表数组中已经通过miTvList数组划分出去了，剩下的空调和洗衣机按照id先后顺序，在数据库product表中可以看到空调id顺序排前面，所以这里列表数组的名称顺序空调放前面。
      "applianceList",
