 ...
 * @LastEditors: tao
 * @LastEditTime: 2022-02-15 13:14:48
 -->
<template>
  <div id="app" name="app">
    <el-container>
          ...
          <div class="ng-promise-box">
            <div class="ng-promise">
              <p class="text">
                ...
                <a class="icon2" href="javascript:;">满999元全场免邮</a>
  ...
  created() {
    ...
    /* window.setTimeout(() => {
      this.$message({
        ...
        message: `
        <p>如果觉得这个项目还不错，</p>
        <p style="padding:10px 0">您可以给云涛源代码仓库点Star支持一下，谢谢！</p>
        <p><a href="https://github.com/" target="_blank">Github传送门</a></p>`,
...
.footer .github .github-but {
  ...
  height: 50px;
  margin: 0 auto;
  background: url("./assets/imgs/xing.png") no-repeat;
}
.footer .mod_help {
  text-align: center;
  color: #888888;
